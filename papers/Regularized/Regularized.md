...
$$
\boldsymbol{u}_{\varepsilon}(\boldsymbol{r})=c \varepsilon \mathcal{K}_{\varepsilon}(\boldsymbol{r}) \overline{\boldsymbol{u}}
$$
...
$$
C_{1}(\hat{\boldsymbol{r}})(1 / r)+\varepsilon^{2} C_{3}(\hat{\boldsymbol{r}})\left(1 / r^{3}\right)+\varepsilon^{4} C_{5}(\hat{\boldsymbol{r}})\left(1 / r^{5}\right)+O\left(1 / r^{7}\right)
$$
...
$$
\boldsymbol{u}_{\varepsilon_{1}, \varepsilon_{2}}(\boldsymbol{r})=\left[\mathcal{K}_{\varepsilon_{1}}(\boldsymbol{r})-\mathcal{K}_{\varepsilon_{2}}(\boldsymbol{r})\right] \boldsymbol{f}
$$
...
$$
\boldsymbol{u}_{\varepsilon_{1}, \varepsilon_{2}}(\boldsymbol{r})=c\left(1 / \varepsilon_{1}-1 / \varepsilon_{2}\right)^{-1}\left[\mathcal{K}_{\varepsilon_{1}}(\boldsymbol{r})-\mathcal{K}_{\varepsilon_{2}}(\boldsymbol{r})\right] \overline{\boldsymbol{u}}
$$
...
$$
\boldsymbol{u}_{\varepsilon_{1}, \varepsilon_{2}, \varepsilon_{3}}(\boldsymbol{r})=\left[w_{1} \mathcal{K}_{\varepsilon_{1}}(\boldsymbol{r})+w_{2} \mathcal{K}_{\varepsilon_{2}}(\boldsymbol{r})+w_{3} \mathcal{K}_{\varepsilon_{3}}(\boldsymbol{r})\right] \boldsymbol{f}
$$

with distinct radial scales ε1 < ε2 < ε3 and weights w1,w2,w3. By analyzing its asymptotic expansion, we obtain

$$
\left(\sum_{i} w_{i}\right) C_{1}(\hat{\boldsymbol{r}})(1 / r)+\left(\sum_{i} w_{i} \varepsilon_{i}^{2}\right) C_{3}(\hat{\boldsymbol{r}})\left(1 / r^{3}\right)+O\left(1 / r^{5}\right)
$$

We can then cancel the two leading terms by setting the weights to

$$
w_{1}=1, w_{2}=-\left(\varepsilon_{3}^{2}-\varepsilon_{1}^{2}\right) /\left(\varepsilon_{3}^{2}-\varepsilon_{2}^{2}\right), w_{3}=\left(\varepsilon_{2}^{2}-\varepsilon_{1}^{2}\right) /\left(\varepsilon_{3}^{2}-\varepsilon_{2}^{2}\right)
$$
